...
```{r, out.width='750px'}
knitr::include_graphics('/cloud/project/doc/Article1.png')
```
```{r, out.width='750px'}
knitr::include_graphics('/cloud/project/doc/Article2.png')
```
...
```{r,out.width='450px'}
knitr::include_graphics('/cloud/project/results/sex.png')
```
```{r, out.width='500px'}
knitr::include_graphics('/cloud/project/results/age.png')
```
...
```{r, fig.dim=c(10,6)}
all_logfold <- read_tsv(file = "/cloud/project/data/03_combined_log2fc.tsv")
diff_expr_genes <- read_tsv(file = "/cloud/project/data/08_diff_expr_genes.tsv")
